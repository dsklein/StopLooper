...
public:
	...
	sigRegion( std::string myLabel, std::string niceName, std::vector<selectionBase*> mySelections );
	sigRegion( std::string myLabel, std::string tabName, std::string rootName, std::vector<selectionBase*> mySelections );
